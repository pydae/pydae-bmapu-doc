...
out[0] = 6.2831853071795862*p[8]*(y[6] - y[11]) - p[11]*x[0];
out[1] = -x[1]*p[12] + u[7];
out[2] = -p[15]*x[2] - y[11] + 1;
...
out[2] = -u[2]/p[0] + y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + pow(y[2], 2)*p[1] - p[7]*y[9]/p[0];
out[3] = -u[3]/p[0] + y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + pow(y[2], 2)*(-p[2] - 1.0/2.0*p[3]) - p[7]*y[10]/p[0];
out[4] = -y[4] + ((u[5] + u[4] < 0) ? (
   0.0
)
: ((u[4] < u[5] + u[4]) ? (
...
: (
   ((u[4] < u[5] + u[4]) ? (
      u[6] < -sqrt(1 - pow(u[4], 2))
   )
   : (
      u[6] < -sqrt(1 - pow(u[5] + u[4], 2))
   ))
))) ? (
   -sqrt(1 - ((u[5] + u[4] < 0) ? (
      0.0
...
out[6] = x[1] - y[6] + u[9];
out[7] = -p[10]*y[7] - y[2]*sin(x[0] + u[10] - y[3]) + p[9]*y[8];
out[8] = -p[10]*y[8] - y[2]*cos(x[0] + u[10] - y[3]) - p[9]*y[7] + u[8];
out[9] = y[2]*y[7]*sin(x[0] + u[10] - y[3]) + y[2]*y[8]*cos(x[0] + u[10] - y[3]) - y[9];
out[10] = y[2]*y[7]*cos(x[0] + u[10] - y[3]) - y[2]*y[8]*sin(x[0] + u[10] - y[3]) - y[10];
out[11] = 1.0*y[6] - y[11];
out[12] = p[14]*x[2] + p[13]*(1 - y[11]) - y[12];
...
out[67] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[68] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[69] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[70] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[83] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[84] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[85] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[86] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[99] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[100] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[101] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[102] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[160] = -y[2]*cos(x[0] + u[10] - y[3]);
out[165] = -sin(x[0] + u[10] - y[3]);
out[166] = y[2]*cos(x[0] + u[10] - y[3]);
out[176] = y[2]*sin(x[0] + u[10] - y[3]);
out[181] = -cos(x[0] + u[10] - y[3]);
out[182] = -y[2]*sin(x[0] + u[10] - y[3]);
out[192] = y[2]*y[7]*cos(x[0] + u[10] - y[3]) - y[2]*y[8]*sin(x[0] + u[10] - y[3]);
out[197] = y[7]*sin(x[0] + u[10] - y[3]) + y[8]*cos(x[0] + u[10] - y[3]);
out[198] = -y[2]*y[7]*cos(x[0] + u[10] - y[3]) + y[2]*y[8]*sin(x[0] + u[10] - y[3]);
out[202] = y[2]*sin(x[0] + u[10] - y[3]);
out[203] = y[2]*cos(x[0] + u[10] - y[3]);
out[208] = -y[2]*y[7]*sin(x[0] + u[10] - y[3]) - y[2]*y[8]*cos(x[0] + u[10] - y[3]);
out[213] = y[7]*cos(x[0] + u[10] - y[3]) - y[8]*sin(x[0] + u[10] - y[3]);
out[214] = y[2]*y[7]*sin(x[0] + u[10] - y[3]) + y[2]*y[8]*cos(x[0] + u[10] - y[3]);
out[218] = y[2]*cos(x[0] + u[10] - y[3]);
out[219] = -y[2]*sin(x[0] + u[10] - y[3]);
...
out[0] = -p[11];
out[9] = 6.2831853071795862*p[8];
out[14] = -6.2831853071795862*p[8];
out[17] = -p[12];
out[34] = -p[15];
out[55] = -p[6]/p[0];
out[72] = -p[6]/p[0];
...
out[6] = 2.0*y[0]*p[1] + y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[7] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[8] = y[0]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[9] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[11] = 2.0*y[0]*(-p[2] - 0.5*p[3]) + y[2]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[12] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[13] = y[0]*(p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[14] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[16] = y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[17] = y[0]*y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[18] = y[0]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3])) + 2.0*y[2]*p[1];
out[19] = y[0]*y[2]*(-p[2]*cos(y[1] - y[3]) - p[1]*sin(y[1] - y[3]));
out[21] = y[2]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3]));
out[22] = y[0]*y[2]*(-p[2]*sin(y[1] - y[3]) + p[1]*cos(y[1] - y[3]));
out[23] = y[0]*(p[2]*cos(y[1] - y[3]) + p[1]*sin(y[1] - y[3])) + 2.0*y[2]*(-p[2] - 0.5*p[3]);
out[24] = y[0]*y[2]*(p[2]*sin(y[1] - y[3]) - p[1]*cos(y[1] - y[3]));
out[30] = -y[2]*cos(x[0] + u[10] - y[3]);
out[31] = -sin(x[0] + u[10] - y[3]);
out[32] = y[2]*cos(x[0] + u[10] - y[3]);
out[35] = y[2]*sin(x[0] + u[10] - y[3]);
out[36] = -cos(x[0] + u[10] - y[3]);
out[37] = -y[2]*sin(x[0] + u[10] - y[3]);
out[40] = y[2]*y[7]*cos(x[0] + u[10] - y[3]) - y[2]*y[8]*sin(x[0] + u[10] - y[3]);
out[41] = y[7]*sin(x[0] + u[10] - y[3]) + y[8]*cos(x[0] + u[10] - y[3]);
out[42] = -y[2]*y[7]*cos(x[0] + u[10] - y[3]) + y[2]*y[8]*sin(x[0] + u[10] - y[3]);
out[43] = y[2]*sin(x[0] + u[10] - y[3]);
out[44] = y[2]*cos(x[0] + u[10] - y[3]);
out[46] = -y[2]*y[7]*sin(x[0] + u[10] - y[3]) - y[2]*y[8]*cos(x[0] + u[10] - y[3]);
out[47] = y[7]*cos(x[0] + u[10] - y[3]) - y[8]*sin(x[0] + u[10] - y[3]);
out[48] = y[2]*y[7]*sin(x[0] + u[10] - y[3]) + y[2]*y[8]*cos(x[0] + u[10] - y[3]);
out[49] = y[2]*cos(x[0] + u[10] - y[3]);
out[50] = -y[2]*sin(x[0] + u[10] - y[3]);
...
out[0] = -p[11];
out[1] = 6.2831853071795862*p[8];
out[2] = -6.2831853071795862*p[8];
out[3] = -p[12];
out[4] = -p[15];
out[10] = -p[6]/p[0];
out[15] = -p[6]/p[0];
...
out[0] = 0.5*Dt*p[11] + 1.0;
out[9] = -3.1415926535897931*Dt*p[8];
out[14] = 3.1415926535897931*Dt*p[8];
out[17] = 0.5*Dt*p[12] + 1.0;
out[34] = 0.5*Dt*p[15] + 1.0;
out[46] = 0.5*Dt;
out[55] = -p[6]/p[0];
out[72] = -p[6]/p[0];
out[92] = -p[7]/p[0];
...
out[0] = 0.5*Dt*p[11] + 1.0;
out[1] = -3.1415926535897931*Dt*p[8];
out[2] = 3.1415926535897931*Dt*p[8];
out[3] = 0.5*Dt*p[12] + 1.0;
out[4] = 0.5*Dt*p[15] + 1.0;
out[5] = 0.5*Dt;
out[10] = -p[6]/p[0];
out[15] = -p[6]/p[0];
out[20] = -p[7]/p[0];
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_smib_vsc_pq_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_smib_vsc_pq_cffi(void) { return NULL; }
#  else
     initsmib_vsc_pq_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_smib_vsc_pq_cffi(void)
{
  return _cffi_init("smib_vsc_pq_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initsmib_vsc_pq_cffi(void)
{
  _cffi_init("smib_vsc_pq_cffi", 0x2601, &_cffi_type_context);
}
#endif
