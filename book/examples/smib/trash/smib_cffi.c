...
out[38] = y[4]*sin(x[0] - y[1]) + y[5]*cos(x[0] - y[1]);
out[39] = -y[0]*y[4]*cos(x[0] - y[1]) + y[0]*y[5]*sin(x[0] - y[1]);
out[42] = 2.0*p[16]*y[4] + y[0]*sin(x[0] - y[1]);
out[43] = 2.0*p[16]*y[5] + y[0]*cos(x[0] - y[1]);
