...
class model: 
    ...
    def __init__(self,matrices_folder='./build'): 
        ...
        self.N_z = 8 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_1_2', 'b_1_2', 'bs_1_2', 'U_1_n', 'U_2_n', 'Omega_b_1', 'S_n_1', 'H_1', 'T1d0_1', 'T1q0_1', 'X_d_1', 'X_q_1', 'X1d_1', 'X1q_1', 'D_1', 'R_a_1', 'K_delta_1', 'K_sec_1', 'K_sat_1', 'K_a_1', 'K_ai_1', 'T_r_1', 'T_a_1', 'T_b_1', 'Droop_1', 'T_gov_1_1', 'T_gov_2_1', 'T_gov_3_1', 'D_t_1', 'omega_ref_1', 'K_ci_gov_1', 'T_wo_pss_1', 'T_1_pss_1', 'T_2_pss_1', 'T_3_pss_1', 'T_4_pss_1', 'K_stab_1', 'V_lim_pss_1', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000.0, 3.846153846153846, -19.23076923076923, 1e-06, 20000.0, 20000.0, 314.1592653589793, 100000000.0, 5.0, 8.0, 0.4, 1.8, 1.7, 0.3, 0.55, 1.0, 0.01, 0.0, 0.0, 1.0, 200, 1e-06, 0.01, 1, 10, 0.05, 1.0, 1.0, 1.0, 0.0, 1.0, 1e-06, 10.0, 0.05, 0.02, 3.0, 5.4, 20, 0.1, 0.0, 0.0, 0.01] 
        self.inputs_ini_list = ['P_1', 'Q_1', 'P_2', 'Q_2', 'v_ref_1', 'p_c_1'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 0.0, 0.0, 1.03, 0.8] 
        self.inputs_run_list = ['P_1', 'Q_1', 'P_2', 'Q_2', 'v_ref_1', 'p_c_1'] 
        self.inputs_run_values_list = [0.0, 0.0, 0.0, 0.0, 1.03, 0.8] 
        self.outputs_list = ['V_1', 'V_2', 'p_e_1', 'v_f_1', 'p_m_1', 'v_ref_1', 'v_pss_1', 'p_c_1'] 
        self.x_list = ['delta_1', 'omega_1', 'e1q_1', 'e1d_1', 'v_r_1', 'x_ab_1', 'xi_v_1', 'x_gov_1_1', 'x_gov_2_1', 'x_wo_pss_1', 'x_12_pss_1', 'x_34_pss_1', 'xi_freq'] 
        self.y_run_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'v_f_1', 'p_m_ref_1', 'p_m_1', 'v_pss_1', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'v_f_1', 'p_m_ref_1', 'p_m_1', 'v_pss_1', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 25, 0, 1, 13, 14, 17, 18, 23, 25, 2, 17, 21, 3, 18, 4, 13, 4, 5, 6, 24, 4, 7, 22, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 25, 13, 14, 15, 16, 19, 13, 14, 15, 16, 20, 13, 14, 15, 16, 13, 14, 15, 16, 0, 2, 13, 14, 17, 18, 0, 3, 13, 14, 17, 18, 0, 13, 14, 17, 18, 19, 0, 13, 14, 17, 18, 20, 4, 5, 6, 21, 24, 1, 17, 18, 22, 26, 1, 7, 8, 23, 1, 9, 10, 11, 24, 1, 25, 12, 25, 26]
    sp_jac_ini_ja = [0, 3, 11, 14, 16, 18, 22, 23, 25, 27, 29, 32, 36, 38, 43, 48, 52, 56, 62, 68, 74, 80, 85, 90, 94, 99, 101, 104]
    sp_jac_ini_nia = 27
    sp_jac_ini_nja = 27
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 25, 0, 1, 13, 14, 17, 18, 23, 25, 2, 17, 21, 3, 18, 4, 13, 4, 5, 6, 24, 4, 7, 22, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 25, 13, 14, 15, 16, 19, 13, 14, 15, 16, 20, 13, 14, 15, 16, 13, 14, 15, 16, 0, 2, 13, 14, 17, 18, 0, 3, 13, 14, 17, 18, 0, 13, 14, 17, 18, 19, 0, 13, 14, 17, 18, 20, 4, 5, 6, 21, 24, 1, 17, 18, 22, 26, 1, 7, 8, 23, 1, 9, 10, 11, 24, 1, 25, 12, 25, 26]
    sp_jac_run_ja = [0, 3, 11, 14, 16, 18, 22, 23, 25, 27, 29, 32, 36, 38, 43, 48, 52, 56, 62, 68, 74, 80, 85, 90, 94, 99, 101, 104]
    sp_jac_run_nia = 27
    sp_jac_run_nja = 27
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 25, 0, 1, 13, 14, 17, 18, 23, 25, 2, 17, 21, 3, 18, 4, 13, 4, 5, 6, 24, 4, 6, 7, 22, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 25, 13, 14, 15, 16, 19, 13, 14, 15, 16, 20, 13, 14, 15, 16, 13, 14, 15, 16, 0, 2, 13, 14, 17, 18, 0, 3, 13, 14, 17, 18, 0, 13, 14, 17, 18, 19, 0, 13, 14, 17, 18, 20, 4, 5, 6, 21, 24, 1, 17, 18, 22, 26, 1, 7, 8, 23, 1, 9, 10, 11, 24, 1, 25, 12, 25, 26]
    sp_jac_trap_ja = [0, 3, 11, 14, 16, 18, 22, 24, 26, 28, 30, 33, 37, 39, 44, 49, 53, 57, 63, 69, 75, 81, 86, 91, 95, 100, 102, 105]
    sp_jac_trap_nia = 27
    sp_jac_trap_nja = 27
