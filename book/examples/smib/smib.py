...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 14 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_1_2', 'b_1_2', 'bs_1_2', 'U_1_n', 'U_2_n', 'S_n_1', 'Omega_b_1', 'H_1', 'T1d0_1', 'T1q0_1', 'X_d_1', 'X_q_1', 'X1d_1', 'X1q_1', 'D_1', 'R_a_1', 'K_delta_1', 'K_sec_1', 'K_a_1', 'K_ai_1', 'T_r_1', 'T_a_1', 'T_b_1', 'Droop_1', 'T_gov_1_1', 'T_gov_2_1', 'T_gov_3_1', 'D_t_1', 'omega_ref_1', 'T_wo_1', 'T_1_1', 'T_2_1', 'T_3_1', 'T_4_1', 'K_stab_1', 'V_lim_1', 'S_n_2', 'F_n_2', 'X_v_2', 'R_v_2', 'K_delta_2', 'K_alpha_2', 'K_rocov_2', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000.0, 3.846153846153846, -19.23076923076923, -5e-07, 20000.0, 20000.0, 100000000.0, 314.1592653589793, 5.0, 8.0, 0.4, 1.8, 1.7, 0.3, 0.55, 1.0, 0.01, 0.0, 0.0, 200, 1e-06, 0.01, 1, 10, 0.05, 1.0, 1.0, 1.0, 0.0, 1.0, 10.0, 0.05, 0.02, 3.0, 5.4, 20, 0.1, 1000000000.0, 50.0, 0.001, 0.0, 0.001, 1e-06, 1e-06, 0.0, 0.0, 0.01] 
        self.inputs_ini_list = ['P_1', 'Q_1', 'P_2', 'Q_2', 'v_ref_1', 'p_c_1', 'alpha_2', 'v_ref_2', 'omega_ref_2', 'delta_ref_2', 'phi_2', 'rocov_2'] 
        self.inputs_ini_values_list  = [0.0, 0.0, 0.0, 0.0, 1.03, 0.8, 0, 1.0, 1.0, 0.0, 0.0, 0.0] 
        self.inputs_run_list = ['P_1', 'Q_1', 'P_2', 'Q_2', 'v_ref_1', 'p_c_1', 'alpha_2', 'v_ref_2', 'omega_ref_2', 'delta_ref_2', 'phi_2', 'rocov_2'] 
        self.inputs_run_values_list = [0.0, 0.0, 0.0, 0.0, 1.03, 0.8, 0, 1.0, 1.0, 0.0, 0.0, 0.0] 
        self.outputs_list = ['V_1', 'V_2', 'p_line_1_2', 'q_line_1_2', 'p_line_2_1', 'q_line_2_1', 'p_e_1', 'v_f_1', 'p_m_1', 'v_ref_1', 'v_pss_1', 'p_c_1', 'alpha_2', 'Dv_2'] 
        self.x_list = ['delta_1', 'omega_1', 'e1q_1', 'e1d_1', 'v_r_1', 'x_ab_1', 'xi_v_1', 'x_gov_1_1', 'x_gov_2_1', 'x_wo_1', 'x_12_1', 'x_34_1', 'delta_2', 'Domega_2', 'Dv_2', 'xi_freq'] 
        self.y_run_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'v_f_1', 'p_m_ref_1', 'p_m_1', 'v_pss_1', 'omega_2', 'i_d_2', 'i_q_2', 'p_s_2', 'q_s_2', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'v_f_1', 'p_m_ref_1', 'p_m_1', 'v_pss_1', 'omega_2', 'i_d_2', 'i_q_2', 'p_s_2', 'q_s_2', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 33, 0, 1, 16, 17, 20, 21, 26, 33, 2, 20, 24, 3, 21, 4, 16, 4, 5, 6, 27, 4, 7, 25, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 28, 33, 13, 14, 15, 33, 16, 17, 18, 19, 22, 16, 17, 18, 19, 23, 16, 17, 18, 19, 31, 16, 17, 18, 19, 32, 0, 2, 16, 17, 20, 21, 0, 3, 16, 17, 20, 21, 0, 16, 17, 20, 21, 22, 0, 16, 17, 20, 21, 23, 4, 5, 6, 24, 27, 1, 25, 34, 1, 7, 8, 26, 1, 9, 10, 11, 27, 13, 28, 12, 18, 19, 29, 30, 12, 14, 18, 19, 29, 30, 12, 18, 19, 29, 30, 31, 12, 18, 19, 29, 30, 32, 1, 28, 33, 15, 33, 34]
    sp_jac_ini_ja = [0, 3, 11, 14, 16, 18, 22, 23, 25, 27, 29, 32, 36, 39, 40, 41, 43, 48, 53, 58, 63, 69, 75, 81, 87, 92, 95, 99, 104, 106, 111, 117, 123, 129, 132, 135]
    sp_jac_ini_nia = 35
    sp_jac_ini_nja = 35
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 33, 0, 1, 16, 17, 20, 21, 26, 33, 2, 20, 24, 3, 21, 4, 16, 4, 5, 6, 27, 4, 7, 25, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 28, 33, 13, 14, 15, 33, 16, 17, 18, 19, 22, 16, 17, 18, 19, 23, 16, 17, 18, 19, 31, 16, 17, 18, 19, 32, 0, 2, 16, 17, 20, 21, 0, 3, 16, 17, 20, 21, 0, 16, 17, 20, 21, 22, 0, 16, 17, 20, 21, 23, 4, 5, 6, 24, 27, 1, 25, 34, 1, 7, 8, 26, 1, 9, 10, 11, 27, 13, 28, 12, 18, 19, 29, 30, 12, 14, 18, 19, 29, 30, 12, 18, 19, 29, 30, 31, 12, 18, 19, 29, 30, 32, 1, 28, 33, 15, 33, 34]
    sp_jac_run_ja = [0, 3, 11, 14, 16, 18, 22, 23, 25, 27, 29, 32, 36, 39, 40, 41, 43, 48, 53, 58, 63, 69, 75, 81, 87, 92, 95, 99, 104, 106, 111, 117, 123, 129, 132, 135]
    sp_jac_run_nia = 35
    sp_jac_run_nja = 35
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 33, 0, 1, 16, 17, 20, 21, 26, 33, 2, 20, 24, 3, 21, 4, 16, 4, 5, 6, 27, 4, 6, 7, 25, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 28, 33, 13, 14, 15, 33, 16, 17, 18, 19, 22, 16, 17, 18, 19, 23, 16, 17, 18, 19, 31, 16, 17, 18, 19, 32, 0, 2, 16, 17, 20, 21, 0, 3, 16, 17, 20, 21, 0, 16, 17, 20, 21, 22, 0, 16, 17, 20, 21, 23, 4, 5, 6, 24, 27, 1, 25, 34, 1, 7, 8, 26, 1, 9, 10, 11, 27, 13, 28, 12, 18, 19, 29, 30, 12, 14, 18, 19, 29, 30, 12, 18, 19, 29, 30, 31, 12, 18, 19, 29, 30, 32, 1, 28, 33, 15, 33, 34]
    sp_jac_trap_ja = [0, 3, 11, 14, 16, 18, 22, 24, 26, 28, 30, 33, 37, 40, 41, 42, 44, 49, 54, 59, 64, 70, 76, 82, 88, 93, 96, 100, 105, 107, 112, 118, 124, 130, 133, 136]
    sp_jac_trap_nia = 35
    sp_jac_trap_nja = 35
