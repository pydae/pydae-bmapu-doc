...
class model: 
    ...
    def __init__(self,matrices_folder='./build'): 
        ...
        self.N_z = 11 
        self.N_store = 100000 
        self.params_list = ['S_base', 'g_1_2', 'b_1_2', 'bs_1_2', 'U_1_n', 'U_2_n', 'Omega_b_1', 'S_n_1', 'H_1', 'T1d0_1', 'T1q0_1', 'X_d_1', 'X_q_1', 'X1d_1', 'X1q_1', 'D_1', 'R_a_1', 'K_delta_1', 'K_sec_1', 'K_sat_1', 'K_a_1', 'K_ai_1', 'T_r_1', 'T_a_1', 'T_b_1', 'Droop_1', 'T_gov_1_1', 'T_gov_2_1', 'T_gov_3_1', 'D_t_1', 'omega_ref_1', 'K_ci_gov_1', 'T_wo_pss_1', 'T_1_pss_1', 'T_2_pss_1', 'T_3_pss_1', 'T_4_pss_1', 'K_stab_1', 'V_lim_pss_1', 'S_n_2', 'F_n_2', 'X_v_2', 'R_v_2', 'K_delta_2', 'K_alpha_2', 'K_rocov_2', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [100000000.0, 3.846153846153846, -19.23076923076923, 1e-06, 20000.0, 20000.0, 314.1592653589793, 100000000.0, 5.0, 8.0, 0.4, 1.8, 1.7, 0.3, 0.55, 1.0, 0.01, 0.0, 0.0, 1.0, 200, 1e-06, 0.01, 1, 10, 0.05, 1.0, 1.0, 1.0, 0.0, 1.0, 1e-06, 10.0, 0.05, 0.02, 3.0, 5.4, 20, 0.1, 1000000000.0, 50.0, 0.001, 0.0, 0.001, 1e-06, 1e-06, 0.0, 0.0, 0.01] 
        ...
        self.outputs_list = ['V_1', 'V_2', 'p_e_1', 'v_f_1', 'p_m_1', 'v_ref_1', 'v_pss_1', 'p_c_1', 'alpha_2', 'Dv_2', 'theta_v_2'] 
        ...
        self.y_run_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'v_f_1', 'p_m_ref_1', 'p_m_1', 'v_pss_1', 'omega_2', 'omega_coi', 'p_agc'] 
        self.xy_list = self.x_list + self.y_run_list 
        self.y_ini_list = ['V_1', 'theta_1', 'V_2', 'theta_2', 'i_d_1', 'i_q_1', 'p_g_1', 'q_g_1', 'v_f_1', 'p_m_ref_1', 'p_m_1', 'v_pss_1', 'omega_2', 'omega_coi', 'p_agc'] 
...
def sp_jac_ini_vectors():
    ...
    sp_jac_ini_ia = [0, 1, 29, 0, 1, 16, 17, 20, 21, 26, 29, 2, 20, 24, 3, 21, 4, 16, 4, 5, 6, 27, 4, 7, 25, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 28, 29, 13, 14, 15, 29, 16, 17, 18, 19, 22, 16, 17, 18, 19, 23, 12, 14, 16, 17, 18, 19, 12, 14, 16, 17, 18, 19, 0, 2, 16, 17, 20, 21, 0, 3, 16, 17, 20, 21, 0, 16, 17, 20, 21, 22, 0, 16, 17, 20, 21, 23, 4, 5, 6, 24, 27, 1, 20, 21, 25, 30, 1, 7, 8, 26, 1, 9, 10, 11, 27, 13, 28, 1, 28, 29, 15, 29, 30]
    sp_jac_ini_ja = [0, 3, 11, 14, 16, 18, 22, 23, 25, 27, 29, 32, 36, 39, 40, 41, 43, 48, 53, 59, 65, 71, 77, 83, 89, 94, 99, 103, 108, 110, 113, 116]
    sp_jac_ini_nia = 31
    sp_jac_ini_nja = 31
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 29, 0, 1, 16, 17, 20, 21, 26, 29, 2, 20, 24, 3, 21, 4, 16, 4, 5, 6, 27, 4, 7, 25, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 28, 29, 13, 14, 15, 29, 16, 17, 18, 19, 22, 16, 17, 18, 19, 23, 12, 14, 16, 17, 18, 19, 12, 14, 16, 17, 18, 19, 0, 2, 16, 17, 20, 21, 0, 3, 16, 17, 20, 21, 0, 16, 17, 20, 21, 22, 0, 16, 17, 20, 21, 23, 4, 5, 6, 24, 27, 1, 20, 21, 25, 30, 1, 7, 8, 26, 1, 9, 10, 11, 27, 13, 28, 1, 28, 29, 15, 29, 30]
    sp_jac_run_ja = [0, 3, 11, 14, 16, 18, 22, 23, 25, 27, 29, 32, 36, 39, 40, 41, 43, 48, 53, 59, 65, 71, 77, 83, 89, 94, 99, 103, 108, 110, 113, 116]
    sp_jac_run_nia = 31
    sp_jac_run_nja = 31
...
def sp_jac_trap_vectors():
    ...
    sp_jac_trap_ia = [0, 1, 29, 0, 1, 16, 17, 20, 21, 26, 29, 2, 20, 24, 3, 21, 4, 16, 4, 5, 6, 27, 4, 6, 7, 25, 7, 8, 1, 9, 1, 9, 10, 1, 9, 10, 11, 12, 28, 29, 13, 14, 15, 29, 16, 17, 18, 19, 22, 16, 17, 18, 19, 23, 12, 14, 16, 17, 18, 19, 12, 14, 16, 17, 18, 19, 0, 2, 16, 17, 20, 21, 0, 3, 16, 17, 20, 21, 0, 16, 17, 20, 21, 22, 0, 16, 17, 20, 21, 23, 4, 5, 6, 24, 27, 1, 20, 21, 25, 30, 1, 7, 8, 26, 1, 9, 10, 11, 27, 13, 28, 1, 28, 29, 15, 29, 30]
    sp_jac_trap_ja = [0, 3, 11, 14, 16, 18, 22, 24, 26, 28, 30, 33, 37, 40, 41, 42, 44, 49, 54, 60, 66, 72, 78, 84, 90, 95, 100, 104, 109, 111, 114, 117]
    sp_jac_trap_nia = 31
    sp_jac_trap_nja = 31
